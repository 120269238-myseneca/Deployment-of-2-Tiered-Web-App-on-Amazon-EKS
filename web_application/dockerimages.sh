...
sudo docker run -d --name application -p 81:81 --network=group1Bridge -e DBHOST=$DBHOST -e DBPORT=$DBPORT -e DBUSER=root -e DBPWD=pw -e bucketname=clo835group1 -e backgroundimage=background.png -e groupName=Group1 application:v0.1